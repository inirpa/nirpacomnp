...
! function(t, e) {
    ...
    if (!r.TweenLite) {
        ...
        var M = v("TweenLite1", function(e, i, r) {
        ...
        o._init = function() {
            ...
            else e = this._initProps(this.target, this._propLookup, this._siblings, a, 0); if (e && M._onPluginEvent("_onInitAllProps", this), a && (this._firstPT || "function" != typeof this.target && this._enabled(!1, !1)), o.runBackwards)
            ...
            var _t = function(t, e, i, r) {
                ...
                xt = o.parseComplex = function(t, e, i, r, n, s, a, l, h, f) {
                    ...
                    for ((-1 !== r.indexOf(",") || -1 !== i.indexOf(",")) && (A = A.join(" ").replace(z, ", ").split(" "), R = R.join(" ").replace(z, ", ").split(" "), M = A.length), M !== R.length && (A = (s || "").split(" "), M = A.length), a.plugin = h, a.setRatio = f, dt.lastIndex = 0, c = 0; M > c; c++)
                        ...
                        a["xs" + a.l] += _.substr(d)
                    } else a["xs" + a.l] += a.l || a["xs" + a.l] ? " " + x : x; if (-1 !== r.indexOf("=") && a.data) {
